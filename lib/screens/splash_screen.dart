...
import 'package:rhyno_admin_app/main.dart';
import 'package:rhyno_admin_app/screens/auth/login.dart';
import 'package:rhyno_admin_app/screens/auth/set_profile.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void redirect() async {
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      await DatabaseMethods().findAdminWithPhoneNumber(phoneNumber).then((v) {
        if (v.isEmpty) {
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'Admin App',
                        style:
                            TextStyle(fontWeight: FontWeight.bold, color: c2),
                      )
                    ],
                  ),
                ),
                    ...
                    child: Column(
                      children: const [
                        ...
                        Text(
                          'Kumar Shashank',
                          style:
                              TextStyle(color: c2, fontWeight: FontWeight.bold),
                        )
                      ],
                    ),
                  ),
